...
| text       | string  | 음성 합성할 문장. UTF-8 인코딩된 텍스트만 지원합니다. CSS API는 최대 5000자의 텍스트까지 음성 합성을 지원합니다. <div class="danger"><p><strong>Caution!</strong></p><p>음성 합성 할 텍스트를 URL encoding으로 변환 후 전송해야 합니다.</p></div> | 필수 |
